...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_planck_1x2uC(
        ...
        MO(3),   KC_LCTL, KC_LGUI, KC_LALT, MO(1),   KC_SPC,          MO(2),   KC_BSPC, KC_ENT,  KC_RCTL, MO(3)
    ),
    ...
    [1] = LAYOUT_planck_1x2uC(
        ...
        MO(7),   KC_P0,   KC_P1,   KC_P2,   KC_P3,   RALT(KC_4),     KC_NO,         KC_PERC,        RALT(KC_RBRC), LSFT(KC_NUHS),   KC_MINS,       MO(7),
        MO(4),   KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS, KC_SPC,                        MO(5),          KC_DEL,        KC_NO,           KC_NO,         KC_NO
    ),
    ...
    [2] = LAYOUT_planck_1x2uC(
        ...
        KC_NO,   KC_LCTL, KC_LGUI, KC_LALT, MO(5),   KC_SPC,             KC_TRNS, KC_BSPC, KC_ENT,  KC_RCTL, KC_NO
    ),
    ...
    [3] = LAYOUT_planck_1x2uC(
        ...
        KC_TRNS, KC_LCTL, KC_LGUI, KC_LALT, MO(4),   KC_SPC,           KC_NO,   KC_BSPC, KC_ENT,  KC_RCTL, KC_TRNS
    ),
    ...
    [5] = LAYOUT_planck_1x2uC(
        ...
        KC_NO,   KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS, KC_NO,            KC_TRNS, KC_BSPC, KC_ENT,  KC_RCTL, KC_NO
    ),
